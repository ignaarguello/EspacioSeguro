            ...
            <div id='Contenedor-Vista1_PageHome'>
                ...
                <section className="SubContenendores">
                    <nav id='Navegacion_Home'>
                        ...
                        <ul id='ListaNavegacion_Home'>
                            <span className='ItemListaNavegacion_Home'>Inicio</span>
                            <span className='ItemListaNavegacion_Home'>Sobre mí</span>
                            <span className='ItemListaNavegacion_Home'>Contacto</span>
                            <span className='ItemListaNavegacion_Home'>Blog</span>
                        </ul>
                    </nav>
                    <h2 id='TituloMarca_Home'>Equilibrio Mental</h2>
                    <div id='Con_ContenidoPrincipal_Home_S2'>
                        ...
                        {/* <div id='PieContenedor_Home_S2'>
                            <h3 id='Subtitulo_LaDepresion-Yo'>©Nombre Propio | Espacio de ayuda emocional</h3>
                        </div> */}
                    </div>
                </section>
                {/* 2 */}
